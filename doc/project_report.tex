...
%
\title{Modelling and Active Inferring Wireless Sensor Data}
...
\begin{figure}[h]
\centering
        \includegraphics[width=0.72\textwidth, height=0.36\textheight]{../temperature_err}
...
\begin{figure}[h]
\centering
        \includegraphics[width=0.72\textwidth, height=0.36\textheight]{../humidity_err}
